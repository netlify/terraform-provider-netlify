...
// ContextValidate validates this dns record create based on context it is used
func (m *DNSRecordCreate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
