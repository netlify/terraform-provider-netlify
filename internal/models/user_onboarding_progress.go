...
// ContextValidate validates this user onboarding progress based on context it is used
func (m *UserOnboardingProgress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
