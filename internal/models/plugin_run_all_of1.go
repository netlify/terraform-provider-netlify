...
// ContextValidate validates this plugin run all of1 based on context it is used
func (m *PluginRunAllOf1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
