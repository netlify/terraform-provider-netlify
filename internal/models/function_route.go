...
// ContextValidate validates this function route based on context it is used
func (m *FunctionRoute) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
