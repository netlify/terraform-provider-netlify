...
const (
	...
	// SetEnvVarValueParamsBodyContextBranchDashDeploy captures enum value "branch-deploy"
	SetEnvVarValueParamsBodyContextBranchDashDeploy string = "branch-deploy"

	// SetEnvVarValueParamsBodyContextDeployDashPreview captures enum value "deploy-preview"
	SetEnvVarValueParamsBodyContextDeployDashPreview string = "deploy-preview"
...
// ContextValidate validates this set env var value params body based on context it is used
func (m *SetEnvVarValueParamsBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
