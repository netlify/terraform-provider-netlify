...
// ContextValidate validates this build status minutes based on context it is used
func (m *BuildStatusMinutes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
