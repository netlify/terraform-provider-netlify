	...
	if m.TrafficRules != nil {
		if err := m.TrafficRules.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("traffic_rules")
			}
			return err
		}
	}
...
// ContextValidate validate this function config based on the context it is used
func (m *FunctionConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FunctionConfig) contextValidateRoutes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FunctionConfig) contextValidateTrafficRules(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.TrafficRules != nil {
		...
		if err := m.TrafficRules.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("traffic_rules")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("traffic_rules")
