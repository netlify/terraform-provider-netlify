...
// ContextValidate validates this asset public signature based on context it is used
func (m *AssetPublicSignature) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
