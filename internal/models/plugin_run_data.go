...
// ContextValidate validates this plugin run data based on context it is used
func (m *PluginRunData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
