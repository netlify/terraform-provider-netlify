...
// ContextValidate validates this function schedule based on context it is used
func (m *FunctionSchedule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
