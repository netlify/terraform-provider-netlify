...
// ContextValidate validates this split test setup based on context it is used
func (m *SplitTestSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
