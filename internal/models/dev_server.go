...
// ContextValidate validates this dev server based on context it is used
func (m *DevServer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
