...
// ContextValidate validates this env var user based on context it is used
func (m *EnvVarUser) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
