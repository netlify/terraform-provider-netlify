...
// ContextValidate validates this payment method data based on context it is used
func (m *PaymentMethodData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
