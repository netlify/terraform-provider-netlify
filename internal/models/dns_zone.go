...
// ContextValidate validate this dns zone based on the context it is used
...
func (m *DNSZone) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
