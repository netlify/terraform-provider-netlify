...
// ContextValidate validates this dns zone setup based on context it is used
func (m *DNSZoneSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
