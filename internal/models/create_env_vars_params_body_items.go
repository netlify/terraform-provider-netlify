...
// ContextValidate validate this create env vars params body items based on the context it is used
func (m *CreateEnvVarsParamsBodyItems) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CreateEnvVarsParamsBodyItems) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
