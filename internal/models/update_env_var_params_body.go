...
// ContextValidate validate this update env var params body based on the context it is used
func (m *UpdateEnvVarParamsBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateEnvVarParamsBody) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
