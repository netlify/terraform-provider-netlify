	...
	if m.OnboardingProgress != nil {
		if err := m.OnboardingProgress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("onboarding_progress")
			}
			return err
		}
	}
...
func (m *User) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateOnboardingProgress(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *User) contextValidateOnboardingProgress(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.OnboardingProgress != nil {
		...
		if err := m.OnboardingProgress.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("onboarding_progress")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("onboarding_progress")
