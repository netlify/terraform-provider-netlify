...
// ContextValidate validates this site processing settings Html based on context it is used
func (m *SiteProcessingSettingsHTML) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
