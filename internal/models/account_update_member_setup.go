...
// ContextValidate validates this account update member setup based on context it is used
func (m *AccountUpdateMemberSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
