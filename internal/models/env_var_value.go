...
const (
	...
	// EnvVarValueContextBranchDashDeploy captures enum value "branch-deploy"
	EnvVarValueContextBranchDashDeploy string = "branch-deploy"

	// EnvVarValueContextDeployDashPreview captures enum value "deploy-preview"
	EnvVarValueContextDeployDashPreview string = "deploy-preview"
...
// ContextValidate validates this env var value based on context it is used
func (m *EnvVarValue) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
