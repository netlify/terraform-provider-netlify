...
// ContextValidate validates this build hook based on context it is used
func (m *BuildHook) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
