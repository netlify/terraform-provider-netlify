...
// ContextValidate validate this asset signature based on the context it is used
func (m *AssetSignature) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AssetSignature) contextValidateAsset(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AssetSignature) contextValidateForm(ctx context.Context, formats strfmt.Registry) error {
