...
// ContextValidate validate this account membership based on the context it is used
func (m *AccountMembership) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountMembership) contextValidateCapabilities(ctx context.Context, formats strfmt.Registry) error {
