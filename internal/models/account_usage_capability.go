...
// ContextValidate validates this account usage capability based on context it is used
func (m *AccountUsageCapability) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
