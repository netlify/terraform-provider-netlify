...
// ContextValidate validate this split tests based on the context it is used
func (m SplitTests) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
