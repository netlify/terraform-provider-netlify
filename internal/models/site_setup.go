...
// ContextValidate validate this site setup based on the context it is used
func (m *SiteSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with SiteSetupAllOf1
	if err := m.SiteSetupAllOf1.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
