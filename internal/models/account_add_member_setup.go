...
// ContextValidate validates this account add member setup based on context it is used
func (m *AccountAddMemberSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
