...
// ContextValidate validates this account setup based on context it is used
func (m *AccountSetup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
