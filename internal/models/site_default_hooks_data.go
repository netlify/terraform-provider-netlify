...
// ContextValidate validates this site default hooks data based on context it is used
func (m *SiteDefaultHooksData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
