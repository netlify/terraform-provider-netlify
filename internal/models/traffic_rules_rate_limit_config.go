...
// ContextValidate validates this traffic rules rate limit config based on context it is used
func (m *TrafficRulesRateLimitConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
