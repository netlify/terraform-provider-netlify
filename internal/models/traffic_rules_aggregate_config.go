...
// ContextValidate validate this traffic rules aggregate config based on the context it is used
func (m *TrafficRulesAggregateConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TrafficRulesAggregateConfig) contextValidateKeys(ctx context.Context, formats strfmt.Registry) error {
