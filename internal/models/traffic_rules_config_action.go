...
// ContextValidate validate this traffic rules config action based on the context it is used
func (m *TrafficRulesConfigAction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TrafficRulesConfigAction) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
