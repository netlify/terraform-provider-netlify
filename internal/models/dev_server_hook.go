...
// ContextValidate validates this dev server hook based on context it is used
func (m *DevServerHook) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
