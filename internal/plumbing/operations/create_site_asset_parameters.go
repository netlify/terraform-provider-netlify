...
CreateSiteAssetParams contains all the parameters to send to the API endpoint
	...
	for the create site asset operation.
...
// WithDefaults hydrates default values in the create site asset params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteAssetParams) WithDefaults() *CreateSiteAssetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create site asset params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteAssetParams) SetDefaults() {
