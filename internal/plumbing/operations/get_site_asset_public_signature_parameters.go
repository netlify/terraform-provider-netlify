...
GetSiteAssetPublicSignatureParams contains all the parameters to send to the API endpoint
	...
	for the get site asset public signature operation.
...
// WithDefaults hydrates default values in the get site asset public signature params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteAssetPublicSignatureParams) WithDefaults() *GetSiteAssetPublicSignatureParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site asset public signature params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteAssetPublicSignatureParams) SetDefaults() {
