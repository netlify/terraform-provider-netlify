...
ConfigureDNSForSiteParams contains all the parameters to send to the API endpoint
	...
	for the configure DNS for site operation.
...
// WithDefaults hydrates default values in the configure DNS for site params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ConfigureDNSForSiteParams) WithDefaults() *ConfigureDNSForSiteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the configure DNS for site params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ConfigureDNSForSiteParams) SetDefaults() {
