...
GetDeployKeyParams contains all the parameters to send to the API endpoint
	...
	for the get deploy key operation.
...
// WithDefaults hydrates default values in the get deploy key params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDeployKeyParams) WithDefaults() *GetDeployKeyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get deploy key params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDeployKeyParams) SetDefaults() {
