...
CreateSiteDeployParams contains all the parameters to send to the API endpoint
	...
	for the create site deploy operation.
...
// WithDefaults hydrates default values in the create site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteDeployParams) WithDefaults() *CreateSiteDeployParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteDeployParams) SetDefaults() {
