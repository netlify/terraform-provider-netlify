...
UpdateAccountMemberParams contains all the parameters to send to the API endpoint
	...
	for the update account member operation.
...
// WithDefaults hydrates default values in the update account member params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateAccountMemberParams) WithDefaults() *UpdateAccountMemberParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update account member params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateAccountMemberParams) SetDefaults() {
