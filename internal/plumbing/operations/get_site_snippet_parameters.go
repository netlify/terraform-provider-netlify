...
GetSiteSnippetParams contains all the parameters to send to the API endpoint
	...
	for the get site snippet operation.
...
// WithDefaults hydrates default values in the get site snippet params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteSnippetParams) WithDefaults() *GetSiteSnippetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site snippet params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteSnippetParams) SetDefaults() {
