...
// NewGetSiteDevServerHookParams creates a new GetSiteDevServerHookParams object,
...
func NewGetSiteDevServerHookParams() *GetSiteDevServerHookParams {
	return &GetSiteDevServerHookParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetSiteDevServerHookParamsWithTimeout creates a new GetSiteDevServerHookParams object
...
// NewGetSiteDevServerHookParamsWithContext creates a new GetSiteDevServerHookParams object
...
// NewGetSiteDevServerHookParamsWithHTTPClient creates a new GetSiteDevServerHookParams object
...
/*
GetSiteDevServerHookParams contains all the parameters to send to the API endpoint

	for the get site dev server hook operation.
...
// WithDefaults hydrates default values in the get site dev server hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDevServerHookParams) WithDefaults() *GetSiteDevServerHookParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site dev server hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDevServerHookParams) SetDefaults() {
