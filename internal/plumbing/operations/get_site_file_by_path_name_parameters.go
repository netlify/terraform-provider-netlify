...
GetSiteFileByPathNameParams contains all the parameters to send to the API endpoint
	...
	for the get site file by path name operation.
...
// WithDefaults hydrates default values in the get site file by path name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteFileByPathNameParams) WithDefaults() *GetSiteFileByPathNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site file by path name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteFileByPathNameParams) SetDefaults() {
