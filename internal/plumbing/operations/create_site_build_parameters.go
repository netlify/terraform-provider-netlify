...
CreateSiteBuildParams contains all the parameters to send to the API endpoint
	...
	for the create site build operation.
...
// WithDefaults hydrates default values in the create site build params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteBuildParams) WithDefaults() *CreateSiteBuildParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create site build params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteBuildParams) SetDefaults() {
