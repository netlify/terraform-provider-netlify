...
SetEnvVarValueParams contains all the parameters to send to the API endpoint
	...
	for the set env var value operation.
...
// WithDefaults hydrates default values in the set env var value params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetEnvVarValueParams) WithDefaults() *SetEnvVarValueParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the set env var value params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetEnvVarValueParams) SetDefaults() {
