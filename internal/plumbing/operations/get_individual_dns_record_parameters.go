...
GetIndividualDNSRecordParams contains all the parameters to send to the API endpoint
	...
	for the get individual Dns record operation.
...
// WithDefaults hydrates default values in the get individual Dns record params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetIndividualDNSRecordParams) WithDefaults() *GetIndividualDNSRecordParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get individual Dns record params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetIndividualDNSRecordParams) SetDefaults() {
