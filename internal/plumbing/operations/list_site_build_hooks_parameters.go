...
ListSiteBuildHooksParams contains all the parameters to send to the API endpoint
	...
	for the list site build hooks operation.
...
// WithDefaults hydrates default values in the list site build hooks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteBuildHooksParams) WithDefaults() *ListSiteBuildHooksParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list site build hooks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteBuildHooksParams) SetDefaults() {
