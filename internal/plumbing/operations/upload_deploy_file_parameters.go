...
UploadDeployFileParams contains all the parameters to send to the API endpoint
	...
	for the upload deploy file operation.
...
// WithDefaults hydrates default values in the upload deploy file params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadDeployFileParams) WithDefaults() *UploadDeployFileParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the upload deploy file params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadDeployFileParams) SetDefaults() {
