...
UpdateSiteBuildHookParams contains all the parameters to send to the API endpoint
	...
	for the update site build hook operation.
...
// WithDefaults hydrates default values in the update site build hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteBuildHookParams) WithDefaults() *UpdateSiteBuildHookParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update site build hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteBuildHookParams) SetDefaults() {
