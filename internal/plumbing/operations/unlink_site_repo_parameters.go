...
UnlinkSiteRepoParams contains all the parameters to send to the API endpoint
	...
	for the unlink site repo operation.
...
// WithDefaults hydrates default values in the unlink site repo params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UnlinkSiteRepoParams) WithDefaults() *UnlinkSiteRepoParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the unlink site repo params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UnlinkSiteRepoParams) SetDefaults() {
