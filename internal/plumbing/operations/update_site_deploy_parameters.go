...
UpdateSiteDeployParams contains all the parameters to send to the API endpoint
	...
	for the update site deploy operation.
...
// WithDefaults hydrates default values in the update site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteDeployParams) WithDefaults() *UpdateSiteDeployParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteDeployParams) SetDefaults() {
