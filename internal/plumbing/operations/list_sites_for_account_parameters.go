...
ListSitesForAccountParams contains all the parameters to send to the API endpoint
	...
	for the list sites for account operation.
...
// WithDefaults hydrates default values in the list sites for account params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSitesForAccountParams) WithDefaults() *ListSitesForAccountParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list sites for account params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSitesForAccountParams) SetDefaults() {
