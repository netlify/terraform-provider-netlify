...
CreateHookBySiteIDParams contains all the parameters to send to the API endpoint
	...
	for the create hook by site Id operation.
...
// WithDefaults hydrates default values in the create hook by site Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateHookBySiteIDParams) WithDefaults() *CreateHookBySiteIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create hook by site Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateHookBySiteIDParams) SetDefaults() {
