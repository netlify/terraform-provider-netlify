...
CreateDeployKeyParams contains all the parameters to send to the API endpoint
	...
	for the create deploy key operation.
...
// WithDefaults hydrates default values in the create deploy key params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateDeployKeyParams) WithDefaults() *CreateDeployKeyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create deploy key params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateDeployKeyParams) SetDefaults() {
