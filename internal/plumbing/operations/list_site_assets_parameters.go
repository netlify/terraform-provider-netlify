...
ListSiteAssetsParams contains all the parameters to send to the API endpoint
	...
	for the list site assets operation.
...
// WithDefaults hydrates default values in the list site assets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteAssetsParams) WithDefaults() *ListSiteAssetsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list site assets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteAssetsParams) SetDefaults() {
