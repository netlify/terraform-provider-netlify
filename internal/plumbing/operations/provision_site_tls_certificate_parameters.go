...
ProvisionSiteTLSCertificateParams contains all the parameters to send to the API endpoint
	...
	for the provision site TLS certificate operation.
...
// WithDefaults hydrates default values in the provision site TLS certificate params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProvisionSiteTLSCertificateParams) WithDefaults() *ProvisionSiteTLSCertificateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the provision site TLS certificate params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProvisionSiteTLSCertificateParams) SetDefaults() {
