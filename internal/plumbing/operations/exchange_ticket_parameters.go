...
ExchangeTicketParams contains all the parameters to send to the API endpoint
	...
	for the exchange ticket operation.
...
// WithDefaults hydrates default values in the exchange ticket params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ExchangeTicketParams) WithDefaults() *ExchangeTicketParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the exchange ticket params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ExchangeTicketParams) SetDefaults() {
