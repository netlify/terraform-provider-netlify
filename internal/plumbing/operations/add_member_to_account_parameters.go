...
AddMemberToAccountParams contains all the parameters to send to the API endpoint
	...
	for the add member to account operation.
...
// WithDefaults hydrates default values in the add member to account params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AddMemberToAccountParams) WithDefaults() *AddMemberToAccountParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the add member to account params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AddMemberToAccountParams) SetDefaults() {
