...
UpdateEnvVarParams contains all the parameters to send to the API endpoint
	...
	for the update env var operation.
...
// WithDefaults hydrates default values in the update env var params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateEnvVarParams) WithDefaults() *UpdateEnvVarParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update env var params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateEnvVarParams) SetDefaults() {
