...
DeleteSiteDevServerHookParams contains all the parameters to send to the API endpoint
	...
	for the delete site dev server hook operation.
...
// WithDefaults hydrates default values in the delete site dev server hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteDevServerHookParams) WithDefaults() *DeleteSiteDevServerHookParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete site dev server hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteDevServerHookParams) SetDefaults() {
