...
ShowServiceInstanceParams contains all the parameters to send to the API endpoint
	...
	for the show service instance operation.
...
// WithDefaults hydrates default values in the show service instance params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ShowServiceInstanceParams) WithDefaults() *ShowServiceInstanceParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the show service instance params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ShowServiceInstanceParams) SetDefaults() {
