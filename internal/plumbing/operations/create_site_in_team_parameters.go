...
CreateSiteInTeamParams contains all the parameters to send to the API endpoint
	...
	for the create site in team operation.
...
// WithDefaults hydrates default values in the create site in team params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteInTeamParams) WithDefaults() *CreateSiteInTeamParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create site in team params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteInTeamParams) SetDefaults() {
