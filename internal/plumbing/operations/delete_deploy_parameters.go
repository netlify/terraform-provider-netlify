...
DeleteDeployParams contains all the parameters to send to the API endpoint
	...
	for the delete deploy operation.
...
// WithDefaults hydrates default values in the delete deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDeployParams) WithDefaults() *DeleteDeployParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDeployParams) SetDefaults() {
