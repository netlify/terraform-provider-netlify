...
// WithDefaults hydrates default values in the get env var params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEnvVarParams) WithDefaults() *GetEnvVarParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get env var params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEnvVarParams) SetDefaults() {
