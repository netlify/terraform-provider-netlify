...
// WithDefaults hydrates default values in the lock deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LockDeployParams) WithDefaults() *LockDeployParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the lock deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LockDeployParams) SetDefaults() {
