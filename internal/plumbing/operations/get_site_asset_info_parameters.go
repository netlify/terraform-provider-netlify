...
GetSiteAssetInfoParams contains all the parameters to send to the API endpoint
	...
	for the get site asset info operation.
...
// WithDefaults hydrates default values in the get site asset info params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteAssetInfoParams) WithDefaults() *GetSiteAssetInfoParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site asset info params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteAssetInfoParams) SetDefaults() {
