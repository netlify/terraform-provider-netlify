...
GetDNSRecordsParams contains all the parameters to send to the API endpoint
	...
	for the get Dns records operation.
...
// WithDefaults hydrates default values in the get Dns records params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSRecordsParams) WithDefaults() *GetDNSRecordsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get Dns records params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSRecordsParams) SetDefaults() {
