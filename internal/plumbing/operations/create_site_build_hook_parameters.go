...
CreateSiteBuildHookParams contains all the parameters to send to the API endpoint
	...
	for the create site build hook operation.
...
// WithDefaults hydrates default values in the create site build hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteBuildHookParams) WithDefaults() *CreateSiteBuildHookParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create site build hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteBuildHookParams) SetDefaults() {
