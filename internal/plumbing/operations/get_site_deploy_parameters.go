...
GetSiteDeployParams contains all the parameters to send to the API endpoint
	...
	for the get site deploy operation.
...
// WithDefaults hydrates default values in the get site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDeployParams) WithDefaults() *GetSiteDeployParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDeployParams) SetDefaults() {
