...
ListAccountAuditEventsParams contains all the parameters to send to the API endpoint
	...
	for the list account audit events operation.
...
// WithDefaults hydrates default values in the list account audit events params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListAccountAuditEventsParams) WithDefaults() *ListAccountAuditEventsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list account audit events params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListAccountAuditEventsParams) SetDefaults() {
