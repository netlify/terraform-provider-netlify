...
ListSiteDevServersParams contains all the parameters to send to the API endpoint
	...
	for the list site dev servers operation.
...
// WithDefaults hydrates default values in the list site dev servers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteDevServersParams) WithDefaults() *ListSiteDevServersParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list site dev servers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteDevServersParams) SetDefaults() {
