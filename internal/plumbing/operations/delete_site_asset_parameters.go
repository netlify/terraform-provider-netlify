...
DeleteSiteAssetParams contains all the parameters to send to the API endpoint
	...
	for the delete site asset operation.
...
// WithDefaults hydrates default values in the delete site asset params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteAssetParams) WithDefaults() *DeleteSiteAssetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete site asset params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteAssetParams) SetDefaults() {
