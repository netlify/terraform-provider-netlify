...
DeleteEnvVarValueParams contains all the parameters to send to the API endpoint
	...
	for the delete env var value operation.
...
// WithDefaults hydrates default values in the delete env var value params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteEnvVarValueParams) WithDefaults() *DeleteEnvVarValueParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete env var value params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteEnvVarValueParams) SetDefaults() {
