...
ShowServiceParams contains all the parameters to send to the API endpoint
	...
	for the show service operation.
...
// WithDefaults hydrates default values in the show service params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ShowServiceParams) WithDefaults() *ShowServiceParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the show service params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ShowServiceParams) SetDefaults() {
