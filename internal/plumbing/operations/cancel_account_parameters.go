...
CancelAccountParams contains all the parameters to send to the API endpoint
	...
	for the cancel account operation.
...
// WithDefaults hydrates default values in the cancel account params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CancelAccountParams) WithDefaults() *CancelAccountParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cancel account params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CancelAccountParams) SetDefaults() {
