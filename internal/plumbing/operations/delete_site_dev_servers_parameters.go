...
DeleteSiteDevServersParams contains all the parameters to send to the API endpoint
	...
	for the delete site dev servers operation.
...
// WithDefaults hydrates default values in the delete site dev servers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteDevServersParams) WithDefaults() *DeleteSiteDevServersParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete site dev servers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteDevServersParams) SetDefaults() {
