...
ListDeployKeysParams contains all the parameters to send to the API endpoint
	...
	for the list deploy keys operation.
...
// WithDefaults hydrates default values in the list deploy keys params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListDeployKeysParams) WithDefaults() *ListDeployKeysParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list deploy keys params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListDeployKeysParams) SetDefaults() {
