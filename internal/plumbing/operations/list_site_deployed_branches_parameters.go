...
ListSiteDeployedBranchesParams contains all the parameters to send to the API endpoint
	...
	for the list site deployed branches operation.
...
// WithDefaults hydrates default values in the list site deployed branches params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteDeployedBranchesParams) WithDefaults() *ListSiteDeployedBranchesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list site deployed branches params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteDeployedBranchesParams) SetDefaults() {
