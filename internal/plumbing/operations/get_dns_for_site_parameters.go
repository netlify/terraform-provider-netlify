...
GetDNSForSiteParams contains all the parameters to send to the API endpoint
	...
	for the get DNS for site operation.
...
// WithDefaults hydrates default values in the get DNS for site params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSForSiteParams) WithDefaults() *GetDNSForSiteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get DNS for site params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSForSiteParams) SetDefaults() {
