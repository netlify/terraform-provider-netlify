...
GetSiteDevServerParams contains all the parameters to send to the API endpoint
	...
	for the get site dev server operation.
...
// WithDefaults hydrates default values in the get site dev server params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDevServerParams) WithDefaults() *GetSiteDevServerParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site dev server params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDevServerParams) SetDefaults() {
