...
UpdateSiteSnippetParams contains all the parameters to send to the API endpoint
	...
	for the update site snippet operation.
...
// WithDefaults hydrates default values in the update site snippet params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteSnippetParams) WithDefaults() *UpdateSiteSnippetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update site snippet params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteSnippetParams) SetDefaults() {
