...
ShowServiceManifestParams contains all the parameters to send to the API endpoint
	...
	for the show service manifest operation.
...
// WithDefaults hydrates default values in the show service manifest params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ShowServiceManifestParams) WithDefaults() *ShowServiceManifestParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the show service manifest params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ShowServiceManifestParams) SetDefaults() {
