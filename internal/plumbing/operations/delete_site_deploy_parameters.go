...
DeleteSiteDeployParams contains all the parameters to send to the API endpoint
	...
	for the delete site deploy operation.
...
// WithDefaults hydrates default values in the delete site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteDeployParams) WithDefaults() *DeleteSiteDeployParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete site deploy params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSiteDeployParams) SetDefaults() {
