...
ListSiteDeploysParams contains all the parameters to send to the API endpoint
	...
	for the list site deploys operation.
...
// WithDefaults hydrates default values in the list site deploys params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteDeploysParams) WithDefaults() *ListSiteDeploysParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list site deploys params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListSiteDeploysParams) SetDefaults() {
