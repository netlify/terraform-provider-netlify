...
CreateSplitTestParams contains all the parameters to send to the API endpoint
	...
	for the create split test operation.
...
// WithDefaults hydrates default values in the create split test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSplitTestParams) WithDefaults() *CreateSplitTestParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create split test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSplitTestParams) SetDefaults() {
