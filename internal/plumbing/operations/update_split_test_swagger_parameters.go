...
UpdateSplitTestParams contains all the parameters to send to the API endpoint
	...
	for the update split test operation.
...
// WithDefaults hydrates default values in the update split test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSplitTestParams) WithDefaults() *UpdateSplitTestParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update split test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSplitTestParams) SetDefaults() {
