...
DeleteDeployKeyParams contains all the parameters to send to the API endpoint
	...
	for the delete deploy key operation.
...
// WithDefaults hydrates default values in the delete deploy key params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDeployKeyParams) WithDefaults() *DeleteDeployKeyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete deploy key params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDeployKeyParams) SetDefaults() {
