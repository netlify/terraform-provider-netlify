...
CreatePluginRunParams contains all the parameters to send to the API endpoint
	...
	for the create plugin run operation.
...
// WithDefaults hydrates default values in the create plugin run params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreatePluginRunParams) WithDefaults() *CreatePluginRunParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create plugin run params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreatePluginRunParams) SetDefaults() {
