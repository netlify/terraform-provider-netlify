...
TransferDNSZoneParams contains all the parameters to send to the API endpoint
	...
	for the transfer Dns zone operation.
...
// WithDefaults hydrates default values in the transfer Dns zone params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TransferDNSZoneParams) WithDefaults() *TransferDNSZoneParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the transfer Dns zone params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TransferDNSZoneParams) SetDefaults() {
