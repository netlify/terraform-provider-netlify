...
UpdateSiteAssetParams contains all the parameters to send to the API endpoint
	...
	for the update site asset operation.
...
// WithDefaults hydrates default values in the update site asset params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteAssetParams) WithDefaults() *UpdateSiteAssetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update site asset params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateSiteAssetParams) SetDefaults() {
