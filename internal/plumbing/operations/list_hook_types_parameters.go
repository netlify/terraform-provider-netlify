...
ListHookTypesParams contains all the parameters to send to the API endpoint
	...
	for the list hook types operation.
...
// WithDefaults hydrates default values in the list hook types params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListHookTypesParams) WithDefaults() *ListHookTypesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list hook types params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListHookTypesParams) SetDefaults() {
