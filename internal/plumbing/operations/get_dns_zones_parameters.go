...
GetDNSZonesParams contains all the parameters to send to the API endpoint
	...
	for the get Dns zones operation.
...
// WithDefaults hydrates default values in the get Dns zones params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSZonesParams) WithDefaults() *GetDNSZonesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get Dns zones params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDNSZonesParams) SetDefaults() {
