...
GetEnvVarsParams contains all the parameters to send to the API endpoint
	...
	for the get env vars operation.
...
// WithDefaults hydrates default values in the get env vars params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEnvVarsParams) WithDefaults() *GetEnvVarsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get env vars params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEnvVarsParams) SetDefaults() {
