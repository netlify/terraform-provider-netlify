...
// WithDefaults hydrates default values in the get hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetHookParams) WithDefaults() *GetHookParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetHookParams) SetDefaults() {
