...
GetSiteMetadataParams contains all the parameters to send to the API endpoint
	...
	for the get site metadata operation.
...
// WithDefaults hydrates default values in the get site metadata params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteMetadataParams) WithDefaults() *GetSiteMetadataParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site metadata params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteMetadataParams) SetDefaults() {
