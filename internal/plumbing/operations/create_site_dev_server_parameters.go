...
CreateSiteDevServerParams contains all the parameters to send to the API endpoint
	...
	for the create site dev server operation.
...
// WithDefaults hydrates default values in the create site dev server params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteDevServerParams) WithDefaults() *CreateSiteDevServerParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create site dev server params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateSiteDevServerParams) SetDefaults() {
