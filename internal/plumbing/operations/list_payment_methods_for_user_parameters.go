...
ListPaymentMethodsForUserParams contains all the parameters to send to the API endpoint
	...
	for the list payment methods for user operation.
...
// WithDefaults hydrates default values in the list payment methods for user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListPaymentMethodsForUserParams) WithDefaults() *ListPaymentMethodsForUserParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list payment methods for user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListPaymentMethodsForUserParams) SetDefaults() {
