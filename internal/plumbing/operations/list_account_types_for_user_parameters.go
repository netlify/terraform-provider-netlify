...
ListAccountTypesForUserParams contains all the parameters to send to the API endpoint
	...
	for the list account types for user operation.
...
// WithDefaults hydrates default values in the list account types for user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListAccountTypesForUserParams) WithDefaults() *ListAccountTypesForUserParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list account types for user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListAccountTypesForUserParams) SetDefaults() {
