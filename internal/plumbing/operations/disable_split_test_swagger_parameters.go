...
DisableSplitTestParams contains all the parameters to send to the API endpoint
	...
	for the disable split test operation.
...
// WithDefaults hydrates default values in the disable split test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DisableSplitTestParams) WithDefaults() *DisableSplitTestParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the disable split test params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DisableSplitTestParams) SetDefaults() {
