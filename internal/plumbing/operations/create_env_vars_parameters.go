...
CreateEnvVarsParams contains all the parameters to send to the API endpoint
	...
	for the create env vars operation.
...
// WithDefaults hydrates default values in the create env vars params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateEnvVarsParams) WithDefaults() *CreateEnvVarsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create env vars params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateEnvVarsParams) SetDefaults() {
