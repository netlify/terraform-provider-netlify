...
UploadDeployFunctionParams contains all the parameters to send to the API endpoint
	...
	for the upload deploy function operation.
...
// WithDefaults hydrates default values in the upload deploy function params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadDeployFunctionParams) WithDefaults() *UploadDeployFunctionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the upload deploy function params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadDeployFunctionParams) SetDefaults() {
