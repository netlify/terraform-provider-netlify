...
// WithDefaults hydrates default values in the enable hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *EnableHookParams) WithDefaults() *EnableHookParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the enable hook params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *EnableHookParams) SetDefaults() {
