...
// Ensure NetlifyProvider satisfies various provider interfaces.
var _ provider.Provider = &NetlifyProvider{}
var _ provider.ProviderWithFunctions = &NetlifyProvider{}

// NetlifyProvider defines the provider implementation.
...
// NetlifyProviderModel describes the provider data model.
...
func (p *NetlifyProvider) Functions(ctx context.Context) []func() function.Function {
